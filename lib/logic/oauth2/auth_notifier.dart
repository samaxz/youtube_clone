...
import 'package:youtube_clone/logic/oauth2/auth_failure.dart';
...
class AuthNotifier extends _$AuthNotifier {
  ...
  late YoutubeAuthenticator authenticator = ref.read(youtubeAuthenticatorProvider);

  Future<void> checkAndUpdateAuthStatus() async {
    state = (await authenticator.isSignedIn()) ? const Authenticated() : const Unauthenticated();
    // log('now auth state is: $state');
  }

  // TODO remove this - call checkAndUpdateAuthStatus()
  // and listen to the state instead
